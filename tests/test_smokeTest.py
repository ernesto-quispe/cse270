...
class TestDefaultSuite():
  ...
  def test_adminPageTest(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("ernesto")
  ...
  def test_joinPageTest(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Ernesto")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Quispe")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Eko Maiko")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("x")
